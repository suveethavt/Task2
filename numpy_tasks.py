...
Original file is located at
    https://colab.research.google.com/drive/1xcOXahUbenNoUfC7Zh4nv2xBrK3RluJy
...
tmr= np.datetime64('today') + np.timedelta64(1)
print(yes,tod,tmr)
...
for x in range(10):
     n.append(x)
Z= np.fromiter(n,dtype=float,count=-1)
print(Z)
...
b = 3
Z = np.zeros((a,a))
np.put(Z, np.random.choice(range(a*a), b, replace=False),1)
print(Z)
